                                          ...
                                          <form action="{{url('admin/category/update',$data->id)}}"  method="POST" enctype="multipart/form-data" >
                                            ...
                                            <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select id="ForminputState" name="parent_category_id" class="form-select" data-choices data-choices-sorting="true" >
    @foreach($parent_category as $dat)
    <?php if($dat->category_name !='all') {
    ?>
    <option <?php if($data->parent_category_id==$dat->id){ echo "selected";} ?> value="{{$dat->id}}">
    ...
    @endforeach
                                            ...
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text"  name="sub_category_name" value="{{$data->sub_category_name}}" class="form-control" id="placeholderInput"
...
<img style="width: 254px;" class="upload" src="{{asset('/category_image/'.$data->sub_category_image)}}">
</div>
<br>
<div class="upload-options">
<label>
<input  style="border: none !important;" type="file" name="sub_category_image"  class="image-upload" id="imgs"  onchange="validateImage()"  > </label>
<input  type="hidden" name="img_cat"  class="image-upload" value="{{$data->sub_category_image}}" >
</div>
</div>
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" name="sub_category_title" value="{{$data->sub_category_title}}" class="form-control" id="labelInput" placeholder="Title">
                                                </div>
                                            </div>
                                            ...
                                            ?>
                                            <option <?php if($data->layout_id==$dat->id){ echo "selected";} ?> value="{{$dat->id}}">
