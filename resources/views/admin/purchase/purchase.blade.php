                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{ url('/admin/purchase/insert') }}" method="POST"
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select id="ForminputState" name="product_id" class="form-select"
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                ...
                                                <select id="ForminputState" class="form-select" data-choices
                                                    data-choices-sorting="true" name="supplier_id">
                                                    <option selected>Choose...</option>
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" name="qty" class="form-control" id="labelInput"
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" name="purchase_price" class="form-control"
                                                    id="labelInput" placeholder="Purchase Price">
                                            </div>
                                        </div>
                                        ...
                                        <tbody>
                                            @foreach ($purchase as $response)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin/purchase/delete', $response->id) }}"
                                                            class="productDelete"><i
                                                                class="fa fa-trash"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="{{ url('/admin/purchase/edit', $response->id) }}"><i
