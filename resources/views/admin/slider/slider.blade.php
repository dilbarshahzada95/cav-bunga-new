                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    <form action="{{ url('/admin/slider/insert') }}" method="POST"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{ asset('/slider_image/' . $new->image) }}"
                                                                    height="50px">
                                                            </div>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin/slider/delete', $new->id) }}"
                                                            class="productDelete"><i
                                                                class="fa fa-trash"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;

                                                        <a href="{{ url('/admin/slider/edit', $new->id) }}"><i
