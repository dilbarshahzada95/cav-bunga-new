                        ...
                        <div class="header-align">
                            <div class="header-align-left">
                                <div class="header-logo-area">
                                    <a href="#">
                                        <img class="logo-main d-none d-sm-block f-logo" src="assets/img/logo.png" alt="Logo" />
                    ...
                    <i class="lastudioicon-zoom-1"></i>
                                    ...
                                    <div class="header-action-flag">
                                        <dropdown>
                                            ...
                                            <label for="toggle2" class="animate"><img src="assets/img/flags/uae.png" alt=""></label>
                                            <ul class="animate m-0">
                                                <li class="animate">
                                                    <p>German</p><img src="assets/img/flags/german.png" alt=""></li>
                                                <li class="animate">
                                                    <p>bangaladesh</p><img src="assets/img/flags/bangaladesh.png" alt=""></li>
                                                <li class="animate">
                                                    <p>Turkey</p>
                                                    <img src="assets/img/flags/turkey.png" alt=" "></li>
                                                <li class="animate">
                                                    <p>German</p><img src="assets/img/flags/german.png" alt=""></li>
                                                <li class="animate">
                                                    <p>bangaladesh</p><img src="assets/img/flags/bangaladesh.png" alt=""></li>
                                    ...
                                    <div class="shop-toolbar-right">
                                        <div class="popularity">
                                            ...
                                            <div class="product-sorting-menu product-view-count">
                                                ...
                                                <span class="current">Popularity <i class="lastudioicon-down-arrow"></i></span>
                                                <ul>
                                                    <li class="active"><a href="#" class="active">What's New</a></li>
                                        ...
                                        <div class="filter__section">
                                            ...
                                            <div class="section__filter">
                                                <div class="product-sorting-menu product-view-count">
                                                    ...
                                                    <span class="current">Price <i class="lastudioicon-down-arrow"></i></span>
                                                    <ul>
                                                        <li class="active"><a href="#" class="active">Price low to high</a></li>
                                                        <li><a href="#">Price high to low</a></li>
                                                        <li><a href="#">Discount</a></li>
                                                    </ul>
                                                </div>
                                                <div class="product-sorting-menu product-sorting">
                                                    <span class="current">Color <i class="lastudioicon-down-arrow"></i></span>
                                                    <ul>
                                                        <li class="active"><a href="#" class="active">Red</a></li>
                                                ...
                                                <div class="product-sorting-menu product-sorting d-sm-none d-lg-block d-md-block">
                                                    <span class="current">Collection <i class="lastudioicon-down-arrow"></i></span>
                                                    <ul>
                                                        <li class="active"><a href="#" class="active">New Collection</a></li>
                                    ...
                                    <div class="product__content">
                                        ...
                                        <div class="more__info">
                                            ...
                                            <a href="#" class="cart-btn">
                                                <img src="assets/img/icons/wallet-cart.png" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
