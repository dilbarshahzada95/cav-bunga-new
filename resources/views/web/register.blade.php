                        ...
                        <div class="header-align">
                            <div class="header-align-left">
                                <div class="header-logo-area">
                                    <a href="#">
                                        <img class="logo-main d-none d-sm-block f-logo" src="{{ asset('web/assets/img/logo-dark.png')}}" alt="Logo" />
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-md-12 justify-content-lg-between d-flex mt-4 sm-d-block">
                                                    <div class="social__login">
                                                        <a href="#">
                                                            <img src="{{ asset('web/assets/img/icons/facebook.png')}}" alt=""> login with facebook
                                                        </a>
                                                    </div>
                                                    <div class="social__login">
                                                        <a href="#">
                                                            <img src="{{ asset('web/assets/img/icons/google.png')}}" alt=""> login with google
                                                        </a>
                                                    </div>
                                                </div>
                                ...
                                <div class="home-slider-content ">
                                    <div class="swiper-container home-slider4-container ">
                                        ...
                                        <div class="image__text">
                                            ...
                                            <h5 class="text-right">A lifestyle brand crafted with love by millennials, for millennials.</h5>
                                        </div>
                                        <div class="swiper-wrapper ">
                                            <div class="swiper-slide ">
                                                <!-- Start Slide Item -->
                                                <div class="home-slider-item ">
                                                    <img src="{{ asset('web/assets/img/products/register.png')}}" alt="">
                                                </div>
                                                <!-- End Slide Item -->
                                            </div>
                                            <div class="swiper-slide ">
                            ...
                            <div class="product-cart ">
                                <div class="product-cart-item ">
                                    <div class="product-img ">
                                        <a href="# "><img src="{{ asset('web/assets/img/shop/cart/1.jpg')}} " alt=" "></a>
                                    </div>
                                ...
                                <div class="product-cart-item ">
                                    <div class="product-img ">
                                        <a href="# "><img src="{{ asset('web/assets/img/shop/cart/2.jpg')}} " alt=" "></a>
                                    </div>
                                    <div class="product-info ">
