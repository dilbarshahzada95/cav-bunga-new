                        ...
                        <div class="col-lg-8">
                            <div class="cart__items position-relative">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="pro-thumbnail">
                                                        <div class="pro-info">
                                                            <div class="pro-img">
                                                                <a href="#"><img
                                                                        src="assets/img/products/backpack-noshadow.png"
                                                                        alt="Moren-Shop"></a>
                                                            </div>
                                                        </div>
                                                        <div class="pro-name">
                                                            ...
                                                            <div class="btn btn-sm btn-remove"><img
                                                                    src="./assets/img/icons/remove.png" /> remove</div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="pro-thumbnail">
                                                        <div class="pro-info">
                                                            <div class="pro-img">
                                                                <a href="#"><img src="assets/img/products/wallet.png"
                                                                        alt="Moren-Shop"></a>
                                                            </div>
                                                        </div>
                                                        <div class="pro-name">
                                                ...
                                                <tr>
                                                    <td class="pro-thumbnail">
                                                        <div class="pro-info">
                                                            <div class="pro-img">
                                                                <a href="#"><img src="assets/img/products/mens-kit.png"
                                                                        alt="Moren-Shop"></a>
                                                            </div>
                                                        </div>
                                                        <div class="pro-name">
                                ...
                                <div class="arrow__back d-sm-none d-lg-block d-md-block">
                                    <a href="shop.html"> <img src="assets/img/icons/back.png" alt=""> continue
                                        shopping</a>
                                </div>
